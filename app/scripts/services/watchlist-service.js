 ...
 */
 ...
 .service('WatchlistService', function WatchlistService() {
    ...
    // [8] Augment Stocks with additional helper functions
    var StockModel = {
    	save: function () {
    ...
    // [9] Augment watchlists with additional helper functions
    var WatchlistModel = {
    ...
    // [10] Helper: Load watchlists from localStorage
    var loadModel = function () {
    	var model = {
    		watchlists: localStorage['StockDog.watchlists'] ?
    		JSON.parse(localStorage['StockDog.watchlists']) : [],
	...
	// [11] Save a new watchlist to watchlists model
	this.save = function (watchlist) {
		watchlist.id = Model.nextId++;
		watchlist.stocks = [];
		_.extend(watchlist, WatchlistModel);
